        ...
        return (
            <div className='login-container'>
                <div className='login-box'>
                    ...
                    <div className='login-input'>
                        <label>Email</label>
                        <input type='text' ref={this.email} className='input-change' onBlur={this.checkValid} placeholder='Enter Email...' />
                        <div className='error-msg'>{this.errors.email}</div>
                    </div>
                    <div className='login-input'>
                        <label>Mobile</label>
                        <input type='number' ref={this.mobile} className='input-change'  onBlur={this.checkValid} placeholder='Enter Mobile Number...' maxLength="10"/>
                    ...
                    <div className='login-input'>
                        ...
                        <input type='password' ref={this.confirmpassword} className='input-change' onBlur={this.checkValid} placeholder='Enter Password...' />
